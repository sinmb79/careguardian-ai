...
| `npm run verify` | PASS — 21 Vitest files / 189 tests; build; all generated HTML CSP; mobile typecheck; Expo doctor 18/18; policy/model; 44 mutation/contract tests; exact audit; YAML workflow contract |
| `npm run release:gate-tests` | PASS — 44 Node mutation/contract tests (3 static + 16 policy + 10 model + 6 audit + 9 workflow) |
