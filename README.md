...
- Play Alpha `1.1.0 (7)`은 2026-07-31부터 테스터에게 제공 중이며, 2026-08-09 현재 참여자 12명·운영 8일째입니다. 앱 재실행 뒤 기기 인증이 완료되어도 잠금 화면을 벗어나지 못하던 문제를 수정한 `1.1.1 (8)`은 final AAB·네이티브 계약·에뮬레이터 회귀 검증을 통과한 뒤 Alpha에 업로드되어 Google 검토 중입니다. 업데이트 제출 뒤에도 참여자 수와 운영 일수는 유지되었습니다.
...
7. [Google Play Alpha 1.1.1 (8) 업데이트 제출 증거](./docs/security/google-play-closed-test-update-2026-08-09.md)
