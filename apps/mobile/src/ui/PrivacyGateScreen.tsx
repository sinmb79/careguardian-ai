...
export function PrivacyGateScreen({ message, isAuthenticating, onUnlock }: PrivacyGateScreenProps) {
  return <View style={styles.container} accessibilityLabel="개인 작업공간 잠금">
    ...
    <Text style={styles.body}>저장된 내용은 이 기기의 인증을 거쳐야 열 수 있습니다.</Text>
...
const styles = StyleSheet.create({
  ...
  button: { minHeight: 56, paddingHorizontal: 24, justifyContent: "center", borderRadius: 999, backgroundColor: "#183138" }, buttonText: { color: "#fffdf7", fontSize: 17, fontWeight: "700" }, disabled: { opacity: 0.55 }
});
