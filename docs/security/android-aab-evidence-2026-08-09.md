...
> **회수됨:** 2026-08-09 추가 검토에서 인증 화면 복귀 뒤 인증 결과 도착 전 앱이 다시 백그라운드로 가는 순서의 P1 경합이 확인되었습니다. 이 AAB의 Google 검토 변경사항을 회수했으며 테스터 제공 후보로 사용하지 않습니다. 후속 후보는 `1.1.2 (9)`입니다.

- 검증일: 2026-08-09 (Asia/Seoul)
- 대상 소스: `7570901b80d2e357274e6b7bb5a7e54bdddfe8a3`
- 앱: `생활후견 AI` / `com.sinmb.careguardianai`
- 당시 판정: **정적·CT-12 검증 PASS, 후속 P1 발견으로 출시 후보 자격 회수**
